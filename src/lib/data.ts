...
export const LABS: Lab[] = [
  {
    ...
    courses: [
      { slug: "drawing", name: "AI 绘图", age: "5–8 岁", count: "8 课", intro: "用 AI 画笔释放想象力：从卡通自画像到完整绘本。", modules: ["卡通自画像", "水彩花园", "动物朋友", "拼贴画", "梦幻城堡", "情绪小怪兽", "未来交通", "绘本出版"], outcome: "一本出版级的个人绘本", reality: "对应真实的文生图提示词工程、风格控制、图像编辑与绘本出版流程，锻炼 AIGC 工具运用与视觉表达能力。结课产出为实体出版绘本《我的实验室日记》。" },
      { slug: "voice", name: "AI 配音", age: "8–12 岁", count: "8 课", intro: "从声音工具到声音表演，含声音克隆与后期处理。", modules: ["工具入门", "参数调节", "情感表达", "SSML 标签", "声音克隆", "后期处理", "商业变现", "前沿技术"], outcome: "一部自己声演的有声绘本", reality: "对应 TTS 语音合成、情感参数调节、SSML 标记语言、声纹克隆原理与伦理、音频后期等真实技术，覆盖语音技术运用与有声内容制作，并初步认识商业变现场景。结课产出为一部完整的有声绘本/广播剧作品。" },
      { slug: "video", name: "AI 视频", age: "10–14 岁", count: "12 课", intro: "从单镜头到多镜头叙事的完整影像创作流程。", modules: ["零基础入门", "提示词进阶", "一致性控制", "多镜头叙事", "视听合成", "封面标题", "品牌打造", "影视动画", "电商实战", "版权合规"], outcome: "一组个人创意短片集", reality: "对应文生视频提示词、镜头一致性控制、多镜头叙事、视听合成、封面标题设计与版权合规，覆盖短视频全流程创作与内容品牌意识。结课产出为个人短片集（含一条商业级实战作品）。" },
    ],
  },
  {
    ...
    desc: "编程工程力：代码 · 应用 · 数据",
    courses: [
      { slug: "python", name: "Python 基础", age: "10+ 岁", count: "11 课", intro: "计算思维入门：从变量到数据结构。", modules: ["初识", "输入输出", "变量", "数据类型", "运算符", "条件分支", "循环", "列表元组", "集合字典"], outcome: "五个独立编写的 Python 程序", reality: "对应 Python 语法体系（变量、数据类型、分支、循环、数据结构），训练编程基础与计算思维，衔接后续全部工程课程与信息学竞赛路径。结课产出为 5 个独立编写的 Python 程序。" },
      { slug: "app", name: "APP 开发", age: "12+ 岁", count: "20 课", intro: "完整的软件工程体验，最终上线真实小程序。", modules: ["环境搭建", "组件", "样式布局", "导航", "数据渲染", "动画", "JS 逻辑", "缓存", "云数据库", "网络请求", "组件封装", "授权", "购物车", "UI 设计", "综合实操"], outcome: "一款上线运行的真实小程序", reality: "对应小程序全流程开发——组件、布局、数据渲染、云数据库、网络请求、组件封装与 UI 设计，训练软件工程思维与完整项目交付能力。结课产出为一款真实上线、可供他人使用的小程序。" },
      { slug: "data", name: "AI 数据分析", age: "12+ 岁", count: "20 课", intro: "数据科学全流程：获取、清洗、分析、可视化。", modules: ["Jupyter", "Python 语法", "NumPy", "Pandas", "数据获取", "数据清洗", "预处理", "统计分析", "Matplotlib", "Seaborn", "Plotly-Dash", "自动化办公", "综合实战"], outcome: "一份真实数据研究报告", reality: "对应 Jupyter/NumPy/Pandas 技术栈、数据获取与清洗、统计学基础与 Matplotlib/Seaborn/Plotly 可视化，训练数据素养与研究报告撰写能力，技能栈可直接复用于学术与竞赛场景。结课产出为一份基于真实数据集的研究报告。" },
    ],
  },
  {
    ...
    courses: [
      { slug: "drone", name: "无人机创客", age: "10–16 岁", count: "40 课 · 4 单元", intro: "从行业科普到真机试飞的完整硬件工程训练。", modules: ["行业科普+仿真飞行（1–10）", "ESP32 硬件编程（11–20）", "传感器原理（21–30）", "组装+真机试飞考核（31–40）"], outcome: "一架亲手组装的无人机与试飞执照", reality: "对应无人机行业认知、ESP32 嵌入式编程、陀螺仪/气压计/磁力计等传感器原理、整机组装与真机试飞考核，训练硬件工程能力与安全规范意识；40 课的完整训练量在同类课程中罕见。结课产出为亲手组装的无人机与试飞考核「苍穹执照」。" },
      { slug: "theory", name: "趣味益智 · AI 原理", age: "8–12 岁", count: "13 课", intro: "以游戏化实验揭开 AI 的运作原理。", modules: ["图灵测试", "机器学习分类", "神经网络", "强化学习", "人脸识别", "贝叶斯过滤", "推荐系统", "语音合成", "数字人", "群体智能", "智慧交通"], outcome: "一张「图灵挑战」认证证书", reality: "以游戏化实验讲解 AI 核心原理——图灵测试、机器学习分类、神经网络、强化学习、贝叶斯过滤、推荐系统、群体智能，让孩子从「使用 AI」升级为「理解 AI」。结课产出为「图灵挑战」AI 原理认证。" },
    ],
  },
];
...
export const EXPERIENCE: Lab = {
  name: "体验中心", en: "PILOT CENTER", color: "#00B8D9", hours: "3 课时",
  desc: "生成式 AI 第一课：绘本 · 数字人 · 计算机视觉",
  courses: [
    { slug: "s0", name: "AI 体验课", age: "5–12 岁", count: "3 课", intro: "三次课建立对生成式 AI 的直观认知：AI 绘本生成、AI 数字人、AI 人脸识别。", modules: ["AI 人脸识别", "AI 数字人制作", "AI 绘本故事"], outcome: "见习研究员身份与个人实验地图（能力图谱）建档", reality: "三节体验课分别对应三大 AIGC 入门应用——AI 绘本生成（文生图）、数字人技术、计算机视觉（人脸识别）。让首次接触 AI 的孩子在 3 次课内完成从「好奇」到「上手」的跨越，并建立个人学习档案。" },
  ],
};
