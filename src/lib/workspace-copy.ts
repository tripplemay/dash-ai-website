...
export const WORKSPACE_LABS: WorkspaceLabCopy[] = [
  {
    ...
    key: "CREATE LAB",
    nameZh: "创作方向",
    nameEn: "Creative Direction",
    descriptionZh: "创意表达：图像、声音与影像",
    descriptionEn: "Creative expression across image, voice, and motion.",
    hours: 28,
    ageZh: "按能力进阶",
    ageEn: "Sequenced by capability",
    color: "#C93F78",
  ...
  },
  {
    ...
    key: "BUILD LAB",
    nameZh: "工程方向",
    nameEn: "Engineering Direction",
    descriptionZh: "计算构建：代码、应用、硬件与数据",
    descriptionEn: "Computational building across code, apps, hardware, and data.",
    hours: 91,
    ageZh: "按能力进阶",
    ageEn: "Sequenced by capability",
    color: "#40549C",
  ...
  },
  {
    ...
    key: "EXPLORE LAB",
    nameZh: "素养方向",
    nameEn: "Literacy Direction",
    descriptionZh: "理解与负责：智能原理与风险判断",
    descriptionEn: "Understanding and responsibility: principles and risk judgment.",
    hours: 13,
    ageZh: "按能力进阶",
    ageEn: "Sequenced by capability",
    color: "#1E9A91",
...
const COURSE_TITLE_COPY: Record<string, { zh: string; en: string }> = {
  ...
  app: { zh: "AI App 开发", en: "AI App Development" },
  data: { zh: "AI 数据分析", en: "AI Data Analysis" },
  drone: { zh: "无人机创客", en: "Drone Maker" },
  theory: { zh: "AI 素养与智能原理", en: "AI Literacy and Intelligent Systems" },
};
