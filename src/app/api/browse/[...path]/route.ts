...
<title>${safeRel} · 芯坐标 CORECOORD</title>
<style>body{font-family:"Noto Sans SC","PingFang SC","Helvetica Neue",sans-serif;background:#F7F8FC;color:#1B2A5F;max-width:860px;margin:0 auto;padding:24px}
header{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:32px;flex-wrap:wrap}header a{background:transparent!important;box-shadow:none!important;padding:0!important;color:#FC7358!important}
h1{font-size:20px;letter-spacing:1px;overflow-wrap:anywhere}ul{list-style:none;padding:0;margin-top:18px}
li{margin:6px 0}.empty{padding:28px 16px;background:#fff;border-radius:4px;color:#525C6D;text-align:center}li a{display:block;background:#fff;border-radius:4px;padding:12px 16px;color:#1B2A5F;
text-decoration:none;font-size:14px;font-weight:700;box-shadow:0 4px 14px rgba(17,19,24,.08)}li a:hover{color:#B83B2A}</style>
